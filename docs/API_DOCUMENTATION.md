# 📚 Pawn AI Hub API Documentation

## 📋 ภาพรวมของระบบ

**Pawn AI Hub API** เป็นระบบจัดการร้านจำนำแบบครบวงจร ที่พัฒนาด้วย **Node.js**, **TypeScript**, **Express.js**, และ **Prisma ORM** โดยออกแบบมาเพื่อรองรับการดำเนินงานของร้านจำนำหลายสาขาอย่างมีประสิทธิภาพ
...
_© 2025 Pawn AI Hub API - Built with ❤️ using Node.js, TypeScript, Express.js, and Prisma ORM_
